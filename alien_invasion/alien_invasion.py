...
class AlienInvasion:
    ...
    def _create_fleet(self):
        ...
        for ros_number in range(number_rows):
            for alien_number in range(number_aliens_x):
                self._create_alien(alien_number, ros_number)
            
    def _create_alien(self, alien_number, ros_number):
        alien =  Alien(self)
        alien_with, alien_height = alien.rect.size
        alien.x = alien_with + 2 * alien_with * alien_number
        alien.rect.x = alien.x
        alien.rect.y = alien_height + 2 * alien_height * ros_number
